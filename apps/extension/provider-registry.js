...
(function(global) {
  ...
  VS.PROVIDERS = [
    { id: 'chatgpt',    name: 'ChatGPT',    slug: 'openai-chatgpt', icon: 'icons/chatgpt.svg',    urlPatterns: ['chatgpt.com','chat.openai.com'], color: '#10a37f', certified: true  },
    { id: 'gemini',     name: 'Gemini',     slug: 'google-gemini',  icon: 'icons/gemini.svg',     urlPatterns: ['gemini.google.com'],            color: '#8e9eff', certified: true  },
    { id: 'claude',     name: 'Claude',     slug: 'claude',         icon: 'icons/claude.svg',     urlPatterns: ['claude.ai'],                    color: '#d97757', certified: false },
    { id: 'deepseek',   name: 'DeepSeek',   slug: 'deepseek',       icon: 'icons/deepseek.svg',   urlPatterns: ['chat.deepseek.com'],           color: '#4d6bfe', certified: false },
    { id: 'grok',       name: 'Grok',       slug: 'grok',           icon: 'icons/grok.svg',       urlPatterns: ['grok.com','x.com/i/grok'],     color: '#f0f0f0', certified: false },
    { id: 'perplexity', name: 'Perplexity', slug: 'perplexity',     icon: 'icons/perplexity.svg', urlPatterns: ['perplexity.ai'],               color: '#20b8cd', certified: false }
  ];
