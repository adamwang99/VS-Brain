(()=>{
  ...
  window.__vsbrainRecovery={STORE_KEY,saveCheckpoint,loadCheckpoint,clearCheckpoint,newFinalizeNonce,getFinalizeNonce,consumeFinalizeNonce,parseTerminationEnvelope};
})();