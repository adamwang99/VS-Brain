...
const seed = 'Reply with exactly 2 lines: line 1 = OK, line 2 = TEST_REAL_PROFILE_20260529';
...
try{
  ...
  const chatHit=await waitBodyHas(chatgpt,'TEST_REAL_PROFILE_20260529');
  const gemHit=await waitBodyHas(gemini,'TEST_REAL_PROFILE_20260529');
  let popupState=null;
  if(extensionId){
